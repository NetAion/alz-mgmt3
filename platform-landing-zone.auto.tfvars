...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "nathanbycroft@gmail.com"
    ...
    primary_nva_subnet_address_prefix                  = "10.1.0.0/26"
    primary_nva_ip_address                             = "10.1.0.4"
  }
...
/*     ama_change_tracking_data_collection_rule_id = "$${ama_change_tracking_data_collection_rule_id}"
  ...
  subscription_placement = {
    identity = {
      ...
      management_group_name = "$${root_parent_management_group_id}"
    }
    connectivity = {
